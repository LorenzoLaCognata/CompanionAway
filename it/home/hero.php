			<section class="hero" aria-labelledby="hero-heading">
				...
				<div class="hero__left">
					<p class="eyebrow">Trasferimenti · Viaggi · Su misura per te</p>

					<h1 class="hero__title" id="hero-heading">
						Il tuo compagno<br>per ogni <em>viaggio</em><br>che lascia il segno.
					</h1>

					<p class="hero__ai-note">Non un algoritmo. Non l’intelligenza artificiale. Una persona vera.</p>

					<p class="hero__body">Che tu stia mettendo radici in un nuovo paese o pianificando il viaggio della tua vita — qui trovi qualcuno che <strong>ti accompagna davvero</strong>, non un template precompilato. Una guida concreta, da chi l’ha già vissuto.</p>

					<blockquote class="manifesto__quote" id="manifesto-quote">
						Credo che i grandi cambiamenti —<br><em>trasferirsi all’estero, ricominciare in un posto nuovo  —</em><br>non debbano mai essere affrontati da soli
					</blockquote>
