		...
		<header class="site-header">
			...
			<nav class="nav" aria-label="Main navigation">
				...
				<ul class="nav-links" role="list">
					...
					<li>
						<a href="/<?= $lang ?>/relocation.php" class="nav-links__item <?php echo ($currentPage === 'relocation.php') ? 'nav-links__item--active' : ''; ?>">Relocation</a>
					</li>
					<li>
						<a href="/<?= $lang ?>/travel.php" class="nav-links__item <?php echo ($currentPage === 'travel.php') ? 'nav-links__item--active' : ''; ?>">Travel</a>
					</li>
					<li>
