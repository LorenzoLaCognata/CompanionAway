			<section class="hero" aria-labelledby="hero-heading">
				...
				<div class="hero__left">
					<p class="eyebrow">Relocation · Travel · Made for you</p>

					<h1 class="hero__title" id="hero-heading">
						Your companion<br>for every <em>journey</em><br>that changes you.
					</h1>

					<p class="hero__ai-note">Not an algorithm. Not AI-generated. A real person, on the other side.</p>

					<p class="hero__body">From navigating a new country to crafting the perfect trip — everything here is <strong>built around your story</strong>, not copied from a template. Real guidance, from someone who lived it.</p>

					<blockquote class="manifesto__quote" id="manifesto-quote">
						I believe that moving through life —<br><em>whether across an ocean or across a city —</em><br>should never feel like something you do alone
					</blockquote>
