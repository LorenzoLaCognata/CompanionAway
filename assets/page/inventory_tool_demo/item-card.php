<?php
	...
	$editUrl = 'inventory_tool_demo.php?action=edit&id=' . (int)$item['id'] . ($listCtx !== '' ? '&' . $listCtx : '');
	$deleteUrl = 'inventory_tool_demo.php?action=delete&id=' . (int)$item['id'] . ($listCtx !== '' ? '&' . $listCtx : '');
?>
				<div class="hi-card">
